...
*/
#ifndef __GSMMote_MOBILECLIENTPROVIDER__
#define __GSMMote_MOBILECLIENTPROVIDER__

#include <Arduino.h>
#include <IPAddress.h>

class GSMMoteMobileClientProvider
{
	protected:
...
extern GSMMoteMobileClientProvider* theGSMMoteMobileClientProvider;
