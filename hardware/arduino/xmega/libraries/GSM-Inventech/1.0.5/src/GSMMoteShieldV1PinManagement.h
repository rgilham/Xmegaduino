...
*/
#ifndef _GSMMoteSHIELDV1PINMANAGEMENT_
#define _GSMMoteSHIELDV1PINMANAGEMENT_

#include <GSMMoteShieldV1AccessProvider.h>
#include <GSMMoteShieldV1DirectModemProvider.h>

class GSMMoteShieldV1PinManagement
{

	private:
	
		GSMMoteShieldV1AccessProvider gsm; // GSM access required for network register with PIN code     
