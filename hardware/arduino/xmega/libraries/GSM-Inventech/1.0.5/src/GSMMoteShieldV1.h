...
*/
#ifndef __GSMMote_SHIELDV1__
#define __GSMMote_SHIELDV1__
...
class GSMMoteShieldV1 : public GSMMoteMobileNetworkProvider, public GSMMoteShieldV1BaseProvider
{
	...
	public:
		...
		/** Constructor **/
		GSMMoteShieldV1(bool debug=false);
