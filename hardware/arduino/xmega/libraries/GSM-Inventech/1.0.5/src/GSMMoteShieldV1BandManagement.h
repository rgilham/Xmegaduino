...
*/
#ifndef __GSMMoteSHIELDV1BANDMANAGEMENT__
#define __GSMMoteSHIELDV1BANDMANAGEMENT__
...
typedef enum GSMMoteGSMBand {UNDEFINED, EGSM_MODE, DCS_MODE, PCS_MODE, EGSM_DCS_MODE, GSM850_PCS_MODE, GSM850_EGSM_DCS_PCS_MODE};
...
class GSMMoteShieldV1BandManagement
{
	private:
	
		GSMMoteShieldV1DirectModemProvider modem; // Direct access to modem
