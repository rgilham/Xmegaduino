...
*/
#ifndef _GSMMoteVOICECALLSERVICE_
#define _GSMMoteVOICECALLSERVICE_

#include <GSMMoteMobileNetworkProvider.h>
#include <GSMMoteMobileVoiceProvider.h>

class GSMMoteVoiceCallService
{
	private:
		uint8_t flags;
	...
	public:
		...
		*/
		GSMMoteVoiceCallService(bool synch=true);

		/** Voice call status
			@return Status of the voice call, as described in GSMMoteMobileVoiceProvider.h
		          { IDLE_CALL, CALLING, RECEIVINGCALL, TALKING};
		*/
		GSMMote_voiceCall_st getvoiceCallStatus();
