...
*/
#ifndef _GSMMoteSHIELDV1DATANETWORKPROVIDER_
#define _GSMMoteSHIELDV1DATANETWORKPROVIDER_

#include <GSMMoteMobileDataNetworkProvider.h>
#include <GSMMoteShieldV1BaseProvider.h>
#include <GSMMoteShieldV1ModemCore.h>
#include <IPAddress.h>

class GSMMoteShieldV1DataNetworkProvider : public GSMMoteMobileDataNetworkProvider, public GSMMoteShieldV1BaseProvider
{
	private:
	...
	public:
		 ...
		 */
		GSMMote_NetworkStatus_t networkAttach(char* networkId, char* user, char* pass)
		{
		...
		/** Detach GPRS/GSM network
			@return connection status
		 */
		GSMMote_NetworkStatus_t networkDetach(){ return detachGPRS();};
		...
		/** Attach to GPRS service
			...
			@return connection status
		 */
		GSMMote_NetworkStatus_t attachGPRS(char* apn, char* user_name, char* password, bool synchronous=true);
		
		/** Detach GPRS service
			@param synchronous	Sync mode
			@return connection status
		 */
		GSMMote_NetworkStatus_t detachGPRS(bool synchronous=true);
