...
// constructor
GSMMoteShieldV1ModemVerification::GSMMoteShieldV1ModemVerification()
{
};

// reset the modem for direct access
int GSMMoteShieldV1ModemVerification::begin()
{
	int result=0;
...
// get IMEI
String GSMMoteShieldV1ModemVerification::getIMEI()
{
	String number(NULL);
