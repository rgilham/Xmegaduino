...
*/
#ifndef __GSMMote_SHIELDV1SMSPROVIDER__
#define __GSMMote_SHIELDV1SMSPROVIDER__

#include <GSMMoteShieldV1ModemCore.h>
#include <GSMMoteMobileSMSProvider.h>
#include <GSMMoteShieldV1SMSProvider.h>


class GSMMoteShieldV1SMSProvider : public GSMMoteMobileSMSProvider, public GSMMoteShieldV1BaseProvider
{		
	public:
		GSMMoteShieldV1SMSProvider();
