...
*/
#ifndef __GSMMote_SHIELDV1SERVERPROVIDER__
#define __GSMMote_SHIELDV1SERVERPROVIDER__

#include <GSMMoteMobileServerProvider.h>
#include <GSMMoteShieldV1BaseProvider.h>

class GSMMoteShieldV1MultiServerProvider : public GSMMoteMobileServerProvider,  public GSMMoteShieldV1BaseProvider
{
	private:
	...
	public:
		...
		/** Constructor */
		GSMMoteShieldV1MultiServerProvider();
