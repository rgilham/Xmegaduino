...
*/
#ifndef __GSMMoteSHIELDV1SCANNETWORKS__
#define __GSMMoteSHIELDV1SCANNETWORKS__
...
class GSMMoteShieldV1ScanNetworks
{
	private:
		GSMMoteShieldV1DirectModemProvider modem;
	...
	public:
		...
		/** Constructor
			...
			@return - 
		*/
		GSMMoteShieldV1ScanNetworks(bool trace=false);
