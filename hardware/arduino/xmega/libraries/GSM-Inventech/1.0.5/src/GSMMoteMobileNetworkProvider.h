...
*/
#ifndef _GSMMoteMOBILENETWORKPROVIDER_
#define _GSMMoteMOBILENETWORKPROVIDER_
...
class GSMMoteMobileNetworkProvider 
{
	private:
	...
	public:
		...
		/** Constructor */
		GSMMoteMobileNetworkProvider();
		
		/** Get network status
			@return network status
		 */
		virtual inline GSMMote_NetworkStatus_t getStatus(){return ERROR;};
...
extern GSMMoteMobileNetworkProvider* theProvider;
