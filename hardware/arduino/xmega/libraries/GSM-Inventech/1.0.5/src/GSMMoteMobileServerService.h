...
*/
#ifndef _GSMMoteMOBILESERVERSERVICE_
#define _GSMMoteMOBILESERVERSERVICE_

#include <GSMMoteMobileNetworkProvider.h>
#include <GSMMoteMobileClientService.h>
#include <Server.h>

class GSMMoteMobileServerService : public Server
{
	private:
	...
	public:
		 ...
		 */
		GSMMoteMobileServerService(uint8_t port, bool synch=true);
		...
		*/
		GSMMoteMobileClientService available(bool synch=true);
