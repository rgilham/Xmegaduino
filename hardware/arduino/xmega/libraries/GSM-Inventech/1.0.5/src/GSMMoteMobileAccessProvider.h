...
*/
#ifndef _GSMMoteMOBILEACCESSPROVIDER_
#define _GSMMoteMOBILEACCESSPROVIDER_

enum GSMMote_NetworkStatus_t { ERROR, IDLE, CONNECTING, GSM_READY, GPRS_READY, TRANSPARENT_CONNECTED, OFF};

class GSMMoteMobileAccessProvider
{
	public:
		// Access functions
		 ...
		 */
		virtual inline GSMMote_NetworkStatus_t begin(char* pin=0,bool restart=true, bool synchronous=true)=0;
