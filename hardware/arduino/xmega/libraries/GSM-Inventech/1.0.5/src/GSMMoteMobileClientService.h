...
*/
#ifndef _GSMMoteMOBILECLIENTSERVICE_
#define _GSMMoteMOBILECLIENTSERVICE_

#include <GSMMoteMobileNetworkProvider.h>
#include <Client.h>


class GSMMoteMobileClientService : public Client
{
	private:
	...
	public:
		 ...
		 */
		GSMMoteMobileClientService(bool synch=true);
		
		/** Constructor
			@param socket		Socket
			@param synch		Sync mode
		 */
		GSMMoteMobileClientService(int socket, bool synch);
