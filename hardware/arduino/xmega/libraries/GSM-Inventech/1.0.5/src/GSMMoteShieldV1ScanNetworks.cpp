...
GSMMoteShieldV1ScanNetworks::GSMMoteShieldV1ScanNetworks(bool trace): modem(trace)
{	
}

GSMMote_NetworkStatus_t GSMMoteShieldV1ScanNetworks::begin()
{
	modem.begin();
	modem.restartModem();
...
String GSMMoteShieldV1ScanNetworks::getCurrentCarrier()
{
...
String GSMMoteShieldV1ScanNetworks::getSignalStrength()
{
...
String GSMMoteShieldV1ScanNetworks::readNetworks()
{
