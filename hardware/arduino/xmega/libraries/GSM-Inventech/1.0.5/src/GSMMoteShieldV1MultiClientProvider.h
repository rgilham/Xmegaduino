...
*/
#ifndef __GSMMote_SHIELDV1CLIENTPROVIDER__
#define __GSMMote_SHIELDV1CLIENTPROVIDER__

#include <GSMMoteMobileClientProvider.h>
#include <GSMMoteShieldV1BaseProvider.h>

class GSMMoteShieldV1MultiClientProvider : public GSMMoteMobileClientProvider,  public GSMMoteShieldV1BaseProvider
{
	private:
	...
	public:
		...
		/** Constructor */
		GSMMoteShieldV1MultiClientProvider();
