...
GSMMoteMobileNetworkProvider* theProvider;

GSMMoteMobileNetworkProvider::GSMMoteMobileNetworkProvider()
{
	socketsAsServer=0x0000;
};


int GSMMoteMobileNetworkProvider::getNewOccupiedSocketAsServer()
{
	int i;
...
bool GSMMoteMobileNetworkProvider::getStatusSocketAsServer(uint8_t socket)
{
