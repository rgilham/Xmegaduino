...
*/
#ifndef _GSMMoteMOBILEDATANETWORKPROVIDER_
#define _GSMMoteMOBILEDATANETWORKPROVIDER_
...
class GSMMoteMobileDataNetworkProvider
{
	public:
		 ...
		 */
		virtual GSMMote_NetworkStatus_t networkAttach(char* networId, char* user, char* pass)=0;
		
		/** Detach GPRS/GSM network
			@return connection status
		 */
		virtual GSMMote_NetworkStatus_t networkDetach()=0;
				
};

extern GSMMoteMobileDataNetworkProvider* theGSMMoteMobileDataNetworkProvider;
