...
*/
#ifndef __GSMMote_MOBILESERVERPROVIDER__
#define __GSMMote_MOBILESERVERPROVIDER__
...
class GSMMoteMobileServerProvider
{	
		/** Get socket status
			@param s			Socket
...
extern GSMMoteMobileServerProvider* theGSMMoteMobileServerProvider;
