...
*/
#ifndef _GSMMoteMOBILEMOCKUPPROVIDER_
#define _GSMMoteMOBILEMOCKUPPROVIDER_

#include <GSMMoteMobileNetworkProvider.h>
#include <GSMMoteMobileVoiceProvider.h>
		
class GSMMoteMobileMockupProvider: public GSMMoteMobileNetworkProvider
{				
	private:
		...
		enum GSMMote_modemlinest_e { IDLE, WAITINGANSWER, SENDINGSMS};
		GSMMote_modemlinest_e lineStatus;
		char* msgExample;
		int msgIndex;
	...
	public:
		...
		/** Constructor */
		GSMMoteMobileMockupProvider();
		
		/** Get network status
			@return network status
		 */
		inline GSMMote_NetworkStatus_t getStatus(){return ERROR;};
		
		/** Get voice call status
			@return call status
		 */
		inline GSMMote_voiceCall_st getvoiceCallStatus(){return IDLE_CALL;};
