...
*/
#ifndef __GSMMote_CIRCULARBUFFER__
#define __GSMMote_CIRCULARBUFFER__
...
class GSMMoteCircularBufferManager
{
	public:
...
class GSMMoteCircularBuffer
{
	private:
		...
		GSMMoteCircularBufferManager* cbm; // Circular buffer manager
	...
	public:
		 ...
		 */
		GSMMoteCircularBuffer(GSMMoteCircularBufferManager* mgr=0);
